...
## ====== Log command line =====
command_line = f'Env: {env_name}, Episodes: {episode},  n. MCTS: {n_mcts_simulations}, N. disks: {N}'
logging.info(command_line)

mcts = MCTS(discount=discount, root_dirichlet_alpha=dirichlet_alpha, n_simulations=n_mcts_simulations, batch_s=1, device=dev)
...
#file_dir = os.path.join(file_dir,'results','acting',str(file_indx))
